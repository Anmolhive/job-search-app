            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-xl glass p-10 shadow-lg rounded-lg" style={{ background: 'rgba(79, 70,229, .5)' }}>
                    ...
                    <div className="flex gap-5">
                        <input value={language} onKeyDown={handelKeyPress} onChange={event => setLanguage(event.target.value)} className="input input-bordered shadow-lg join-item text-slate-950 w-full dark:text-white dark:placeholder:text-white" placeholder="E.g., JavaScript, Python, Java.." />
